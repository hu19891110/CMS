...
<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#Edit-Page-{{$page->id}}">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{URL::route('admin.pages.edit.inline',$page)}}" type="button" class="btn btn-success">Inline Edit</a>
                <a href="{{URL::route('admin.pages.edit',$page)}}" type="button" class="btn btn-danger">Admin Edit</a>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
</div>